...
{
    /** @test */
    public function it_includes_cancelled_orders_by_default()
    {
        $this->assertCount(50, Order::all());
    }

    /** @test */
    public function it_can_be_configured_to_exclude_cancelled_orders_by_default()
    {
    ...
    /** @test */
    public function it_can_include_cancelled_orders()
    {
        $this->assertCount(50, Order::withCancelled()->get());
    }

    /** @test */
    public function it_can_only_receive_cancelled_orders()
    {
        $this->assertCount(25, Order::onlyCancelled()->get());
    }

    /** @test */
    public function it_can_exclude_cancelled_orders()
    {
        $this->assertCount(25, Order::withoutCancelled()->get());
    }

    /** @test */
    public function it_can_keep_multiple_cancelled_orders()
    {
        $this->assertCount(25, Order::withoutCancelled()->get());
